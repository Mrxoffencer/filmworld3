...
from authy.views import UserProfile, ReviewDetail, like, unlike, UserProfileMoviesWatched, UserProfileSeriesWatched, UserProfileWatchList, UserProfileMoviesReviewed, About, Contact, PrivacyPolicies, Disclaimer, TermsAndConditions
...
urlpatterns = [
    ...
    path('privacypolices/', PrivacyPolicies, name='privacypolices'),
